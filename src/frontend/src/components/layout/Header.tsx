    ...
    <header className="bg-surface sticky top-3 z-40 border-b-4 border-slate-border mx-3">
      <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
        ...
        <nav className="hidden lg:flex gap-8 font-bold uppercase tracking-wider text-xs">
          ...
          <Link to="/#why-doodlepaws" className="hover:text-primary border-b-2 border-transparent hover:border-primary pb-1 transition-all">Success Stories</Link>
          <Link to="/#why-doodlepaws" className="hover:text-primary border-b-2 border-transparent hover:border-primary pb-1 transition-all">Foster</Link>
        </nav>

        <button type="button" aria-label="Login (coming soon)" className="bg-slate-border text-white px-6 py-2 rounded-full font-bold uppercase text-xs tracking-[0.2em] shadow-[6px_6px_0px_0px_rgba(255,179,71,1)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all">
          Login
        </button>
      </div>
    </header>
